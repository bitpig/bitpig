...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Bitpig " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"bitpig.xyz", "bitpig.xyz"},
	{"bitpigfarm.com", "bitpigfarm.com"},
	{"bitpigfarm.xyz", "bitpigfarm.xyz"},
    {NULL, NULL}
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Bitpig is probably already running."), addrBind.ToString().c_str());
        else
